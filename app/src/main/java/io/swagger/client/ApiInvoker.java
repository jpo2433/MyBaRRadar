...
public class ApiInvoker {
  ...
  private HttpClientConnectionManager ignoreSSLConnectionManager;
  ...
  */
  ...
  private HttpClient getClient(String host) {
    if (client == null) {
      if (ignoreSSLCertificates && ignoreSSLConnectionManager != null) {
        ...
        client = HttpClientBuilder.create().setConnectionManager(ignoreSSLConnectionManager).build();
      } else {
  ...
  private void initConnectionManager() {
    try {
      ...
      ignoreSSLConnectionManager = new PoolingHttpClientConnectionManager();
